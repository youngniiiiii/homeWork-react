...
function LearnStateAnd() {
  ...
  return (
    <div className="m-10 flex flex-col gap-2 items-start" onMouseMove={handlePrintMousePosition}>
      <h2 className="text-indigo-600 text-2xl uppercase">상태 및 이펙트 학습하기</h2>
      ...
      <form className="w-1/2" onSubmit={handleSaveRepository}>
        ...
        <div role="group" className="flex gap-1 mt-5">
          ...
          <button type="reset" onClick={handleResetRepository} className="py-1.5 px-2.5 bg-rose-500 text-white">
            취소
          </button>
        </div>
      </form>
